...
private fun assertDataCollectionOptions() {
    ...
    onView(withText(R.string.preference_experiments)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
    onView(withText(R.string.preference_experiments_summary)).check(matches(withEffectiveVisibility(Visibility.VISIBLE)))
}
...
private fun experimentsButton() = onView(withText(R.string.preference_experiments))
